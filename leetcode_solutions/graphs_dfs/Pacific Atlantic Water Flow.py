...
class Solution:
    ...
    def pacificAtlantic1(self, heights: List[List[int]]) -> List[List[int]]:
        ...
        def dfs(r, c, t):
            ...
            #     return True
            if (r == 0 and c == col - 1) or (r == row - 1 and c == 0):
                return True
            if min(r, c) < 0 or r >= row or c >= col or (r, c) in temp:
                avoid.add((r, c))
                return False
            if heights[r][c] > t:
                avoid.add((r, c))
            ...
            temp.add((r, c))
            res = (dfs(r + 1, c, t) or dfs(r, c + 1, t) or dfs(r - 1, c, t) or dfs(r, c - 1, t))
